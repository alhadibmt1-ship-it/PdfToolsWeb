...
import { FileDown, Combine, FileText, Image, SplitSquareHorizontal } from "lucide-react";

const quickActions = [
  { id: "compress", label: "Compress", icon: FileDown, path: "/compress", color: "text-green-500" },
  ...
  { id: "pdf-to-jpg", label: "To JPG", icon: Image, path: "/pdf-to-jpg", color: "text-orange-500" },
