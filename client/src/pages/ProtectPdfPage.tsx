...
export default function ProtectPdfPage() {
  ...
  const handleProtect = async () => {
    ...
    try {
      ...
      toast({
        title: "Success!",
        description: "PDF protected with password",
      });
    } catch (error) {
      setStatus("error");
      toast({
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-8">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold mb-3">Password Protect PDF</h1>
            <p className="text-muted-foreground leading-relaxed">
              Secure your PDF with a password. The file will be encrypted and require the password to open.
            </p>
          </div>
            ...
            {status === "success" && resultUrl && (
              <div className="rounded-lg border bg-card p-6 space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Make sure to remember your password. You'll need it to open the file.
                </p>
                <Button 
