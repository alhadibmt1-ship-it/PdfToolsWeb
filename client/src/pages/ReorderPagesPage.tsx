            ...
            {status === "success" && resultUrl && (
              <div className="rounded-lg border bg-card p-6 space-y-4">
                ...
                <div className="pt-3 border-t border-border/50 flex flex-wrap justify-center gap-x-4 gap-y-1 text-sm">
                  ...
                  <Link href="/delete-pages" className="text-primary hover:underline font-medium" data-testid="link-post-download-2">Delete Pages →</Link>
                </div>
              </div>
            )}
          </div>

          <EnhancedToolSEOContent toolId="reorder-pages" />
