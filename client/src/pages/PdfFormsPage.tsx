...
export default function PdfFormsPage() {
  useSEO({
    title: "Create PDF Form Free Online | PDF HUB 24",
    description: "Create fillable PDF forms with text fields, checkboxes and dropdowns free online. Build interactive forms. No signup. PDF HUB 24.",
    keywords: "pdf-forms free, pdf-forms online, pdf-forms no signup, pdf hub 24",
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-8">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold mb-3">Create PDF Form</h1>
            <p className="text-muted-foreground leading-relaxed mb-4">Create fillable PDF forms with text fields, checkboxes and dropdowns free online. Build interactive forms. No signup. PDF HUB 24.</p>
            <TrustBadges />
          </div>
          <div className="space-y-6">
            ...
            {files.length > 0 && status === "idle" && (
              <div className="rounded-lg border bg-card p-6 space-y-4">
                ...
                <Button onClick={handleProcess} className="w-full" size="lg">Create PDF Form</Button>
              </div>
            )}
            <ProcessingState status={status === "processing" || status === "error" ? status : "idle"} progress={progress} message="Creating form..." />
          ...
          <RelatedTools currentToolId="pdf-forms" />
        </div>
      </main>
      <Footer />
    </div>
