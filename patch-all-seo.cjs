...
const SEO_MAP = {
  ...
  "TermsPage.tsx": {
    ...
    description: "Terms of Service for PDF HUB 24. Read our usage terms and conditions for all free PDF tools.",
  ...
  "HtmlSitemapPage.tsx": {
    ...
    description: "HTML sitemap for PDF HUB 24. Browse all 49+ free PDF tools, blog posts, guides and resources.",
  ...
  "SeoAuditPage.tsx": {
    ...
    description: "Internal SEO audit page for PDF HUB 24 tools.",
  ...
  "ProgrammaticSeoPage.tsx": {
    ...
    description: "Free PDF tools online. Compress, merge, split, convert and edit PDFs free with PDF HUB 24.",
  ...
  "not-found.tsx": {
    ...
    description: "The page you're looking for doesn't exist. Browse 49+ free PDF tools at PDF HUB 24.",
