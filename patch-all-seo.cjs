...
const SEO_MAP = {
  ...
  "JpgToPdfPage.tsx": {
    ...
    description: "Convert JPG to PDF free online. Combine multiple images into one PDF instantly with custom page order. No signup, no watermarks added. PDF HUB 24.",
  ...
  "ProtectPdfPage.tsx": {
    ...
    description: "Password protect PDF files free online. Add 256-bit AES encryption to any PDF instantly with custom permissions. No signup required. PDF HUB 24.",
  ...
  "OcrPdfPage.tsx": {
    ...
    description: "OCR PDF free online. Convert scanned PDFs to searchable, selectable and editable text instantly. Supports 100+ languages. No signup. PDF HUB 24.",
  ...
  "RotatePdfPage.tsx": {
    ...
    description: "Rotate PDF pages free online. Fix sideways or upside-down PDF pages permanently in one click. Rotate 90, 180 or 270 degrees. PDF HUB 24.",
  ...
  "ReorderPagesPage.tsx": {
    ...
    description: "Reorder PDF pages free online. Rearrange, reorganize and sort PDF pages with easy drag and drop. Fix page order instantly. No signup. PDF HUB 24.",
  ...
  "RedactPdfPage.tsx": {
    ...
    description: "Redact PDF free online. Permanently black out sensitive text and images from any PDF document. Complies with GDPR and HIPAA. No signup. PDF HUB 24.",
  ...
  "RepairPdfPage.tsx": {
    ...
    description: "Repair corrupted and damaged PDF files free online. Fix broken PDFs that won't open, are missing pages, or show errors. No signup required. PDF HUB 24.",
  ...
  "ComparePdfPage.tsx": {
    ...
    description: "Compare two PDF files free online. Instantly find all differences between PDF documents side by side. Track changes and edits. No signup. PDF HUB 24.",
  ...
  "TranslatePdfPage.tsx": {
    ...
    description: "Translate PDF documents free online to 100+ languages instantly. Preserve formatting while translating content. No signup, no watermarks. PDF HUB 24.",
  ...
  "ExtractTextPage.tsx": {
    ...
    description: "Extract text from any PDF free online. Copy and export all text content from PDFs instantly — including scanned documents with OCR. No signup. PDF HUB 24.",
  ...
  "HtmlToPdfPage.tsx": {
    ...
    description: "Convert HTML or any webpage to PDF free online. All CSS styles, images and layouts preserved perfectly. No signup required. Download instantly. PDF HUB 24.",
  ...
  "PdfToExcelPage.tsx": {
    ...
    description: "Convert PDF to Excel free online. Extract tables and data from PDFs into editable spreadsheets. Preserves rows, columns and cell data. No signup. PDF HUB 24.",
  ...
  "ExcelToPdfPage.tsx": {
    ...
    description: "Convert Excel to PDF free online. Transform XLSX and XLS spreadsheets to PDF with perfect formatting, charts and tables preserved. No signup. PDF HUB 24.",
  ...
  "PdfToPptPage.tsx": {
    ...
    description: "Convert PDF to PowerPoint free online. Get fully editable PPTX slides from any PDF instantly. Works with Google Slides too. No signup. PDF HUB 24.",
  ...
  "PdfToPngPage.tsx": {
    ...
    description: "Convert PDF to PNG free online. Export every PDF page as a high-resolution lossless PNG image. Perfect for graphics and design. No signup. PDF HUB 24.",
  ...
  "PngToPdfPage.tsx": {
    ...
    description: "Convert PNG images to PDF free online. Combine multiple PNG files into one PDF instantly. Lossless quality, transparent backgrounds supported. No signup. PDF HUB 24.",
  ...
  "TiffToPdfPage.tsx": {
    ...
    description: "Convert TIFF images to PDF free online. Transform TIF and multi-page TIFF files to PDF instantly. High quality output. No signup required. PDF HUB 24.",
  ...
  "WebpToPdfPage.tsx": {
    ...
    description: "Convert WebP images to PDF free online. Transform WebP files to PDF instantly with full quality. Batch convert multiple WebP files. No signup. PDF HUB 24.",
  ...
  "ScanToPdfPage.tsx": {
    ...
    description: "Scan documents to PDF free using your phone camera or scanner. Convert photos to searchable PDF instantly. No signup, no watermark. PDF HUB 24.",
  ...
  "PdfToAPage.tsx": {
    ...
    description: "Convert PDF to PDF/A free online for long-term archiving and compliance. Create ISO-standard archival PDFs instantly. No signup required. PDF HUB 24.",
  ...
  "PdfViewerPage.tsx": {
    ...
    description: "View PDF files online free. Open and read any PDF directly in your browser without downloading software. Fast, secure, no signup required. PDF HUB 24.",
  ...
  "ImageCompressorPage.tsx": {
    ...
    description: "Compress images free online. Reduce JPG, PNG and WebP file sizes by up to 90% without visible quality loss. Perfect for web and email. No signup. PDF HUB 24.",
  ...
  "ResizeImagePage.tsx": {
    ...
    description: "Resize images free online. Change image dimensions and resolution instantly for web, print or social media. Supports JPG, PNG, WebP. No signup. PDF HUB 24.",
  ...
  "FreePdfEditorPage.tsx": {
    ...
    description: "Free PDF editor online. Edit, annotate, fill forms, merge, split, compress and convert PDFs without Adobe Acrobat. No download, no signup. PDF HUB 24.",
  ...
  "WriteForUsPage.tsx": {
    ...
    description: "Write for PDF HUB 24. Submit guest posts and tutorials about PDF tools, tips and document management. Reach our audience of professionals and students.",
  ...
  "PressKitPage.tsx": {
    ...
    description: "PDF HUB 24 press and media kit. Download logos, screenshots, brand assets and company information for press coverage and media mentions.",
  ...
  "PdfFileFormatsPage.tsx": {
    ...
    description: "Complete guide to PDF file formats. Learn about PDF, PDF/A, PDF/X and PDF/E and other PDF variants. Free reference guide from PDF HUB 24 experts.",
  ...
  "PdfGlossaryPage.tsx": {
    ...
    description: "Complete PDF glossary and dictionary. Learn the meaning of PDF terms, acronyms and technical definitions used in document management and conversion.",
